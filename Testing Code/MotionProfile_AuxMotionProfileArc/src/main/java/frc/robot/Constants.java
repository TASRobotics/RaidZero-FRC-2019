...
public class Constants {
	 ...
	 */
	public final static double kSensorUnitsPerRotation = 81.9467;
	...
	public final static Gains kGains_Distanc = new Gains( 2.2, 0.004,  50, 0.717,            50,  0.50 );
	public final static Gains kGains_Turning = new Gains( 8, 0.0,  100, 0.21787,            100,  1.00 );
	...
	public final static Gains kGains_MotProf = new Gains( 2.2, 0.004,  50, 0.717,  50,  0.8 ); /* measured 6800 velocity units at full motor output */
