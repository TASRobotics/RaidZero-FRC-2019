...
public class Robot extends TimedRobot {
	...
	TalonSRX leftFollow = new TalonSRX(3);
	TalonSRX rightFollow = new TalonSRX(4);
	...
	public void teleopInit(){
		...
		rightFollow.follow(_rightMaster);
		leftFollow.follow(_leftMaster);
		...
		_rightMaster.configSelectedFeedbackCoefficient(	3600.0/8196.0,
														Constants.PID_TURN,
														Constants.kTimeoutMs);
		...
		_rightMaster.configMotionAcceleration(1000, Constants.kTimeoutMs);
		_rightMaster.configMotionCruiseVelocity(500, Constants.kTimeoutMs);
	...
	public void teleopPeriodic() {
		//System.out.println(_pidgey.getFusedHeading());
		...
		if(!_state){
			...
			double finalHeading_units = -900;//Constants.kPigeonUnitsPerRotation * turn * -1.0 * 0.25;
		...
		//System.out.println("Encoder Ticks " + _rightMaster.getSelectedSensorPosition(0));
		_firstCall = false;
	}
